...
<body>
  ...
  <script>
  	function loginBtn(){
  		alert("로그인을 진행합니다.");
  		// 링크로 주소 이동을 하면 데이터가 넘어가지 않음
  		//loaction.href="./dologin.jsp";
  		frm.submit();
  	}
  </script>
  ...
  <div class="container">
    <div class="login-box">
      ...
      <%--
            <form action="/p0203_01/loginok.jsp" method="post" name="frm">
       --%>
      <form action="/p0203_01/loginok222222.jsp" method="post" name="frm">
        ...
        <input type="checkbox" name="cook_save" id="cook_save" value="ok">
        <label for="cook_save">아이디 저장</label>
